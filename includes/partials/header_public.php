    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="<?= url('submit/index.php') ?>">Submit Data</a></li>
                <li class="nav-item"><a class="nav-link" href="<?= url('submit/update.php') ?>">Update Submission</a></li>
